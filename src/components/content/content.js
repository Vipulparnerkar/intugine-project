...
const Content = (props) =>{
    ...
    // const all = props.Data.map((item,i)=>{
        

    //     if(typeof props.Data[i].scan != "undefined"){
    //        return props.Data[i].scan.map((items,idx)=>{
    //             return <div>{props.Data[i].scan[idx].location}</div>
    //         })
    //     }
    // })
